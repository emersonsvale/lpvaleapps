<template>
  <div>
    <div class="flex flex-wrap items-center justify-between gap-4 mb-6">
      <div>
        <h1 class="text-2xl font-semibold text-zinc-100 mb-1">Portifolio</h1>
        <p class="text-zinc-400">Itens do portifolio (site e valeapps).</p>
      </div>
      <NuxtLink
    ...
    <div v-else class="space-y-3">
      ...
      <p v-if="!projetos?.length" class="text-zinc-500">Nenhum projeto cadastrado. Crie o primeiro em Novo projeto.</p>
    </div>
  </div>
</template>

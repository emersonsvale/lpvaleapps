<template>
  <canvas ref="canvasRef" class="absolute inset-0 w-full h-full block pointer-events-none" />
</template>
...
const { library: ogl, loadLibrary: loadOGL } = useOGL()
...
onMounted(async () => {
  ...
  // Lazy load OGL apenas quando necessário

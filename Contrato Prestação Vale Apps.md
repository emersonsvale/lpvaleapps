...
**b) \[DENOMINAÇÃO SOCIAL COMPLETA DA PARTE REVELADORA / CLIENTE\]**, com sede na \[INSERIR ENDEREÇO COMPLETO\], CEP \[ \], inscrita no CNPJ/MF sob o nº \[ \], aqui representada na forma de seu contrato social, doravante denominada ("CONTRATANTE");
...
* **1.2.1** O prazo de entrega do referido PRODUTO será de até **\[INSERIR PRAZO EX: 120\]** dias úteis, após o pagamento da primeira parcela e assinatura do contrato pelas partes.  
...
* **1.3.1 Garantia:** A CONTRATADA concede à CONTRATANTE uma garantia de **\[INSERIR PRAZO DE GARANTIA, EX: 90\]** dias, a contar da data da entrega final do sistema, para a correção de defeitos de fabricação (bugs) que venham a ser identificados no sistema entregue.  
...
*(Tabela baseada no escopo original de SLAs)*

1.4. Regramento de Abertura de Chamados de Bugs

* **1.4.1.** A CONTRATANTE deverá reportar os bugs à CONTRATADA por meio dos canais de atendimento estabelecidos, seja por e-mail para o endereço **\[INSERIR E-MAIL DE SUPORTE DA VALE APPS\]** ou pelo aplicativo **\[INSERIR CANAL DE ATENDIMENTO/SISTEMA SE HOUVER\]**, utilizando o formulário de abertura de chamados específico para reportar bugs.  
...
* **1.4.5.** A garantia se limita à correção dos bugs sem custo adicional para a CONTRATANTE dentro do prazo acordado. Após o término do período de garantia, a correção de bugs será cobrada conforme os termos do contrato principal ou secundário em vigor, caso haja.  
  * **1.4.5.1.** A não existência de um contrato de sustentação/Suporte, ensejará em um custo de **R$ \[INSERIR VALOR DA SUA HORA DE SUPORTE AVULSO\]/hora**, com atendimento em caráter emergencial.  
...
* **6.1.** Para o cumprimento das obrigações legais e contratuais listadas nas cláusulas 1 e 4, a CONTRATANTE pagará a CONTRATADA, mediante emissão de Nota Fiscal pela CONTRATADA, conforme a natureza do objeto deste Contrato, os seguintes valores:  
  * **6.1.1 R$ \[INSERIR VALOR TOTAL DO PROJETO\] (\[VALOR POR EXTENSO\])**, a ser pago da seguinte forma: **\[INSERIR CONDIÇÕES DE PAGAMENTO, PARCELAS E DATAS AQUI\]**. O saldo residual deverá ser quitado na entrega final do PRODUTO, conforme descrito na cláusula 1;  
...
* **7.1.** O pagamento/quitação dos valores descritos na cláusula 6.1, deverá ser feito, em conta corrente da CONTRATADA, detalhada abaixo:  
  * **RAZÃO SOCIAL:** \[INSERIR RAZÃO SOCIAL DA VALE APPS\]  
  * **CNPJ:** \[INSERIR CNPJ DA VALE APPS\]  
  * **BANCO:** \[INSERIR NOME DO BANCO\]  
  * **AGÊNCIA:** \[INSERIR AGÊNCIA\]  
  * **CONTA CORRENTE:** \[INSERIR CONTA\]  
...
* 12.1. RESILIÇÃO: Havendo interesse em sua resilição, a parte interessada notificará a parte contrária, por escrito, com antecedência mínima de 30 (trinta) dias, para que, de comum acordo, resolva o vínculo comercial, ressalvados os direitos até então constituídos em favor dos interessados.  
  * **12.1.1** Em caso de resilição motivada por interesse da CONTRATANTE, essa incorrerá em multa de **\[INSERIR %, EX: 80%\]** do valor contratado no item 6.1, descontados os valores já quitados, além da desobrigação da CONTRATADA de entregar qualquer artefato até então por ela produzido.  
...
* *(Demais disposições gerais sobre anticorrupção, comunicações e foros permanecem válidas conforme os itens 13.5 a 13.20 do documento original)*  
* **13.21.** Fica desde já eleito o Foro da Comarca de **\[INSERIR SUA CIDADE AQUI\]**, Estado de **\[INSERIR SEU ESTADO AQUI\]**, para dirimir eventuais questões oriundas do Acordo, renunciando as PARTES a qualquer outro, por mais privilegiado que seja.
...
**\[INSERIR CIDADE E DATA DE ASSINATURA\]**

---

**VALE APPS \[RAZÃO SOCIAL\]** (CONTRATADA)
